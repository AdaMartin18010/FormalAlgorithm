...
1. **Knuth, D. E.** (1976). "Big Omicron and Big Omega and Big Theta". *ACM SIGACT News*, 8(2), 18-24.
   - 系统阐述 $O$, $\Omega$, $\Theta$ 记号的严格定义与使用规范。

2. **Cormen, T. H., Leiserson, C. E., Rivest, R. L., & Stein, C.** (2009). *Introduction to Algorithms* (3rd ed.). MIT Press. ISBN: 978-0262033848.
   - 第3章渐进记号，第4章递推关系求解与主定理。

3. **Brassard, G.** (1985). "Crusade for a Better Notation". *ACM SIGACT News*, 17(1), 60-64.
   - 对渐进记号使用规范的深入讨论。

4. **Sedgewick, R., & Flajolet, P.** (2013). *An Introduction to the Analysis of Algorithms* (2nd ed.). Addison-Wesley. ISBN: 978-0321905758.
   - 算法分析的符号方法与渐近技术。

5. **Akra, M., & Bazzi, L.** (1998). "On the Solution of Linear Recurrence Equations". *Computational Optimization and Applications*, 10(2), 195-210.
   - Akra-Bazzi 方法：主定理的非均匀推广。

6. **Tarjan, R. E.** (1985). "Amortized Computational Complexity". *SIAM Journal on Algebraic and Discrete Methods*, 6(2), 306-318.
   - 摊还分析的系统性理论，与渐进分析互补。
