...
1. **Knuth, D. E.** (1997). *The Art of Computer Programming, Vol. 1: Fundamental Algorithms* (3rd ed.). Addison-Wesley. ISBN: 978-0201896831.
   - 算法分析的经典奠基之作，系统阐述时间复杂度与基本操作计数。

2. **Cormen, T. H., Leiserson, C. E., Rivest, R. L., & Stein, C.** (2009). *Introduction to Algorithms* (3rd ed.). MIT Press. ISBN: 978-0262033848.
   - 算法导论标准教材，第2-3章涵盖渐进分析与时间复杂度。

3. **Sipser, M.** (2012). *Introduction to the Theory of Computation* (3rd ed.). Cengage Learning. ISBN: 978-1133187790.
   - 计算理论导论，第7章时间复杂度与层次定理。

4. **Aho, A. V., Hopcroft, J. E., & Ullman, J. D.** (1974). *The Design and Analysis of Computer Algorithms*. Addison-Wesley. ISBN: 978-0201000290.
   - 算法设计与分析的经典教材，奠定现代复杂度分析框架。

5. **Tarjan, R. E.** (1985). "Amortized Computational Complexity". *SIAM Journal on Algebraic and Discrete Methods*, 6(2), 306-318.
   - 摊还分析的系统性理论，与时间复杂度的平均最坏情况分析密切相关。
