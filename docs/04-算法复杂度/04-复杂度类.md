...
- 建立P、NP、PSPACE等复杂度类的完整理论框架。

### 关键术语与符号 / Glossary

- 复杂度类、P类、NP类、PSPACE类、EXP类、完全性问题、归约技术。
- 术语对齐与引用规范：`docs/术语与符号总表.md`，`01-基础理论/00-撰写规范与引用指南.md`

### 术语与符号规范 / Terminology & Notation

- 复杂度类（Complexity Classes）：按计算资源需求对问题进行分类。
- P类（P Class）：多项式时间可解问题。
- NP类（NP Class）：非确定性多项式时间可验证问题。
- PSPACE类（PSPACE Class）：多项式空间可解问题。
- 记号约定：`P`、`NP`、`PSPACE`、`EXP` 表示不同的复杂度类。
...
P/NP/PSPACE 等复杂度类可与 **MIT 18.404 Theory of Computation**、**CMU 15-251**、**Stanford CS 161**、**Berkeley CS 170** 等课程对标。课程与模块映射见 [国际课程对标表](../国际课程对标表.md)。

### 可知边界与认识论参考 / Knowable Boundaries and Epistemology

复杂度下界与复杂度类分离（如 P vs NP）刻画了**可知边界**：哪些问题在给定资源下可判定、哪些问题的可证明下界存在。与 [Stanford SEP - Philosophy of Computer Science](https://plato.stanford.edu/entries/computer-science/) §认识论地位、可判定性与验证的局限 呼应。见 [项目哲科结构说明](../项目哲科结构说明.md)。
...
- [4.4 复杂度类 / Complexity Classes](#44-复杂度类--complexity-classes)
  - [摘要 / Executive Summary](#摘要--executive-summary)
  - [关键术语与符号 / Glossary](#关键术语与符号--glossary)
  - [术语与符号规范 / Terminology \& Notation](#术语与符号规范--terminology--notation)
  - [交叉引用导航 / Cross-References](#交叉引用导航--cross-references)
  - [国际课程参考 / International Course References](#国际课程参考--international-course-references)
  - [可知边界与认识论参考 / Knowable Boundaries and Epistemology](#可知边界与认识论参考--knowable-boundaries-and-epistemology)
  - [快速导航 / Quick Links](#快速导航--quick-links)
- [目录 (Table of Contents)](#目录-table-of-contents)
- [1. 基本概念 (Basic Concepts)](#1-基本概念-basic-concepts)
  - [1.1 复杂度类定义 (Definition of Complexity Classes)](#11-复杂度类定义-definition-of-complexity-classes)
  - [1.2 复杂度类记号 (Complexity Class Notation)](#12-复杂度类记号-complexity-class-notation)
  - [1.3 复杂度类层次 (Complexity Class Hierarchy)](#13-复杂度类层次-complexity-class-hierarchy)
- [1.4 内容补充与思维表征 / Content Supplement and Thinking Representation](#14-内容补充与思维表征--content-supplement-and-thinking-representation)
- [2. P类与NP类 (P and NP Classes)](#2-p类与np类-p-and-np-classes)
  - [2.1 P类定义 (Definition of P Class)](#21-p类定义-definition-of-p-class)
  - [2.2 NP类定义 (Definition of NP Class)](#22-np类定义-definition-of-np-class)
  - [2.3 P vs NP问题 (P vs NP Problem)](#23-p-vs-np问题-p-vs-np-problem)
  - [2.4 NP完全问题 (NP-Complete Problems)](#24-np完全问题-np-complete-problems)
- [3. PSPACE类 (PSPACE Class)](#3-pspace类-pspace-class)
  - [3.1 PSPACE类定义 (Definition of PSPACE Class)](#31-pspace类定义-definition-of-pspace-class)
  - [3.2 PSPACE完全问题 (PSPACE-Complete Problems)](#32-pspace完全问题-pspace-complete-problems)
  - [3.3 PSPACE与NP的关系 (Relationship between PSPACE and NP)](#33-pspace与np的关系-relationship-between-pspace-and-np)
- [4. EXP类 (EXP Class)](#4-exp类-exp-class)
  - [4.1 EXP类定义 (Definition of EXP Class)](#41-exp类定义-definition-of-exp-class)
  - [4.2 EXP完全问题 (EXP-Complete Problems)](#42-exp完全问题-exp-complete-problems)
  - [4.3 NEXP类 (NEXP Class)](#43-nexp类-nexp-class)
- [5. 复杂度类关系 (Complexity Class Relationships)](#5-复杂度类关系-complexity-class-relationships)
  - [5.1 包含关系 (Containment Relations)](#51-包含关系-containment-relations)
  - [5.2 分离问题 (Separation Problems)](#52-分离问题-separation-problems)
  - [5.3 相对化结果 (Relativization Results)](#53-相对化结果-relativization-results)
- [6. 完全性问题 (Complete Problems)](#6-完全性问题-complete-problems)
  - [6.1 完全性定义 (Definition of Completeness)](#61-完全性定义-definition-of-completeness)
  - [6.2 各类的完全问题 (Complete Problems for Different Classes)](#62-各类的完全问题-complete-problems-for-different-classes)
  - [6.3 归约技术 (Reduction Techniques)](#63-归约技术-reduction-techniques)
  - [经典归约示例：3-SAT → Vertex-Cover / Classic Reduction Example: 3-SAT → Vertex-Cover](#经典归约示例3-sat--vertex-cover--classic-reduction-example-3-sat--vertex-cover)
- [7. 复杂度类应用 (Applications of Complexity Classes)](#7-复杂度类应用-applications-of-complexity-classes)
  - [7.1 密码学应用 (Cryptographic Applications)](#71-密码学应用-cryptographic-applications)
  - [7.2 算法设计应用 (Algorithm Design Applications)](#72-算法设计应用-algorithm-design-applications)
  - [7.3 系统设计应用 (System Design Applications)](#73-系统设计应用-system-design-applications)
- [8. 实现示例 (Implementation Examples)](#8-实现示例-implementation-examples)
  - [8.1 复杂度类分析工具 (Complexity Class Analysis Tool)](#81-复杂度类分析工具-complexity-class-analysis-tool)
  - [8.2 NP完全问题实现 (NP-Complete Problem Implementation)](#82-np完全问题实现-np-complete-problem-implementation)
  - [8.3 PSPACE完全问题实现 (PSPACE-Complete Problem Implementation)](#83-pspace完全问题实现-pspace-complete-problem-implementation)
  - [8.4 复杂度类测试 (Complexity Class Testing)](#84-复杂度类测试-complexity-class-testing)
...
### 1.3 复杂度类层次 (Complexity Class Hierarchy)
...
**解释与直观**：复杂度类用资源界（时间/空间）划分问题；$P$、$NP$、$PSPACE$、$EXP$ 等构成层次，$P$ vs $NP$ 为核心开放问题；归约与完备性用于比较类与证明下界。

**概念属性表**：$P$ — 多项式时间可判定；$NP$ — 多项式时间可验证；$PSPACE$ — 多项式空间；$EXP$ — 指数时间；多一归约 $\leq_m$ — 保持可判定性；$NP$-完备 — $NP$ 中最难问题。

**概念关系**：复杂度类 —depends_on— 01-时间复杂度、02-空间复杂度、03-渐进分析；$P \subseteq NP \subseteq PSPACE \subseteq EXP$；归约 — 完备性与下界。

**概念依赖图**：$DTIME/NTIME/DSPACE/NSPACE$ → $P/NP/PSPACE$；归约 → $NP$-完备、$NP$-困难；Cook-Levin → SAT 为 $NP$-完备。

**思维导图**：复杂度类 → $P/NP/PSPACE/EXP$、归约、完备性、层次定理 → 算法设计、下界、密码学。

**多维矩阵**：$P/NP/coNP/PSPACE$ — 包含与未知关系；多一归约/图灵归约 — 归约类型；完备问题 — SAT、Clique、Hamilton 等。

**公理定理推理证明决策树**：定义 $P/NP$ → 验证与判定等价；Cook-Levin → SAT 为 $NP$-完备；层次定理 → $P \subsetneq EXP$ 等。

**应用决策建模树**：判问题是否在 $P$ → 给多项式算法；证 $NP$-困难 → 归约自已知 $NP$-完备（见 §2–§3）；形式化 → 见 09-计算复杂度理论。

---

## 2. P类与NP类 (P and NP Classes)

### 2.1 P类定义 (Definition of P Class)
...
### 2.2 NP类定义 (Definition of NP Class)
...
### 2.4 NP完全问题 (NP-Complete Problems)
...
## 3. PSPACE类 (PSPACE Class)

### 3.1 PSPACE类定义 (Definition of PSPACE Class)
...
### 3.2 PSPACE完全问题 (PSPACE-Complete Problems)
...
### 3.3 PSPACE与NP的关系 (Relationship between PSPACE and NP)
...
### 4.1 EXP类定义 (Definition of EXP Class)
...
### 4.2 EXP完全问题 (EXP-Complete Problems)
...
## 5. 复杂度类关系 (Complexity Class Relationships)

### 5.1 包含关系 (Containment Relations)
...
### 5.3 相对化结果 (Relativization Results)
...
## 6. 完全性问题 (Complete Problems)

### 6.1 完全性定义 (Definition of Completeness)
...
### 6.2 各类的完全问题 (Complete Problems for Different Classes)
...
### 经典归约示例：3-SAT → Vertex-Cover / Classic Reduction Example: 3-SAT → Vertex-Cover

**定理 6.3.1** (3-SAT 到 Vertex-Cover 的归约) (Theorem - Reduction from 3-SAT to Vertex-Cover):
...
**构造要点** (Construction Outline):

1. **子句构造** (Clause Construction):
   对每个子句 $C_i = (\ell_{i1} \vee \ell_{i2} \vee \ell_{i3})$，创建一个三角形（3个顶点对应三个文字），三条边全连。
...
2. **冲突边构造** (Conflict Edge Construction):
   对每个变量 $x$，在所有出现 $x$ 的文字顶点与所有出现 $\neg x$ 的文字顶点之间连一条 **冲突边**（防止两者同时被选入覆盖）。
...
5. **方向 ⇐** (Direction ⇐):
   若有大小 $\leq k$ 的覆盖，则每个子句必须至少有 **2** 个顶点在覆盖中（因为三角形有 3 条边），剩下的顶点对应一个满足文字；冲突边的覆盖保证同一变量不出现真/假冲突，从而得到满足赋值。
...
**结论** (Conclusion):
3-SAT $\leq_p$ Vertex-Cover $\Rightarrow$ Vertex-Cover 是 NP-Complete。

3-SAT $\leq_p$ Vertex-Cover $\Rightarrow$ Vertex-Cover is NP-Complete.

---

## 7. 复杂度类应用 (Applications of Complexity Classes)

### 7.1 密码学应用 (Cryptographic Applications)
...
### 7.2 算法设计应用 (Algorithm Design Applications)
...
### 7.3 系统设计应用 (System Design Applications)
...
### 8.1 复杂度类分析工具 (Complexity Class Analysis Tool)
...
### 8.2 NP完全问题实现 (NP-Complete Problem Implementation)
...
### 8.3 PSPACE完全问题实现 (PSPACE-Complete Problem Implementation)
...
### 8.4 复杂度类测试 (Complexity Class Testing)
...
- `04-算法复杂度/01-时间复杂度.md` - 时间复杂度（复杂度类的基础）
- `04-算法复杂度/02-空间复杂度.md` - 空间复杂度（空间复杂度类）
- `04-算法复杂度/03-渐进分析.md` - 渐进分析（复杂度类的分析工具）
- `04-算法复杂度/05-通信复杂度.md` - 通信复杂度（通信复杂度类）
- `09-算法理论/01-算法基础/01-算法设计理论.md` - 算法设计理论（复杂度类在算法设计中的应用）
- 相关内容已整合到本文档（原 `view/算法全景梳理-2025-01-11.md` §2.4, §5）

### 知识体系位置 / Knowledge System Position

本文档属于 **04-算法复杂度** 模块，是算法复杂度分类的核心文档，为算法理论提供复杂度类分类框架。
