...
- [Hopcroft-Karp 算法](#hopcroft-karp-算法)
  - [一、理论基础](#一理论基础)
    - [核心突破](#核心突破)
    - [关键洞察](#关键洞察)
  - [二、算法设计](#二算法设计)
  ...
  - [**Rust 实现引用**: `examples/algorithms/src/hopcroft_karp.rs`](#rust-实现引用-examplesalgorithmssrchopcroft_karprs)
  - [知识导航](#知识导航-1)
  - [学习目标](#学习目标-1)
