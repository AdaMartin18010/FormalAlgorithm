...
- [Johnson 算法](#johnson-算法)
  - [一、理论基础](#一理论基础)
    - [为什么需要 Johnson 算法？](#为什么需要-johnson-算法)
    - [重赋权的正确性](#重赋权的正确性)
  - [二、算法设计](#二算法设计)
    - [步骤](#步骤)
    - [关键数据结构](#关键数据结构)
  - [三、复杂度分析](#三复杂度分析)
  - [四、形式化验证](#四形式化验证)
    - [引理 25.1（三角不等式）](#引理-251三角不等式)
    - [定理 25.2（路径等价性）](#定理-252路径等价性)
    - [推论](#推论)
  - [五、应用场景](#五应用场景)
    - [与 Floyd-Warshall 的选型](#与-floyd-warshall-的选型)
  - [六、扩展变体](#六扩展变体)
  - [参考](#参考)
  - [参考文献](#参考文献)
  - [知识导航](#知识导航)
  ...
  - [**Rust 实现引用**: `examples/algorithms/src/johnson.rs`](#rust-实现引用-examplesalgorithmssrcjohnsonrs)
  - [知识导航](#知识导航-1)
  - [学习目标](#学习目标-1)
