...
联邦学习可与 **CMU 10-403**、**Stanford CS 234** 及隐私/分布式 ML 专题对标。课程与模块映射见 [国际课程对标表](../../国际课程对标表.md)。
...
- [基本概念 (Basic Concepts)](#基本概念-basic-concepts)
  ...
  - [内容补充与思维表征 / Content Supplement and Thinking Representation](#内容补充与思维表征--content-supplement-and-thinking-representation)
    ...
    - [多维矩阵：联邦算法与隐私 / Multi-Dimensional Comparison](#多维矩阵联邦算法与隐私--multi-dimensional-comparison)
    - [决策树：联邦学习选型 / Decision Tree](#决策树联邦学习选型--decision-tree)
...
- [收敛性分析 (Convergence Analysis)](#收敛性分析-convergence-analysis)
  - [收敛性分析 (Convergence Analysis)](#收敛性分析-convergence-analysis-1)
...
- [8. 最新研究进展 (2024-2025) (Latest Research Advances)](#8-最新研究进展-2024-2025-latest-research-advances)
  - [8.1 FeTS联邦肿瘤分割基准](#81-fets联邦肿瘤分割基准)
  - [8.2 联邦学习隐私攻击与防御](#82-联邦学习隐私攻击与防御)
- [参考文献](#参考文献)
- [知识导航](#知识导航)
- [学习目标](#学习目标)
...
联邦学习在数据不出本地前提下通过模型聚合进行协作学习。联邦平均、联邦优化与隐私保护（差分隐私、安全聚合）构成核心；与 09-01-17 神经网络、09-03-03 分布式算法衔接。通信轮次与收敛性、隐私保证见本文。

#### 概念属性表 / Concept Attribute Table

| 属性名 | 类型/范围 | 含义 | 备注 |
|--------|-----------|------|------|
| 联邦学习 | 学习范式 | §基本概念 | 数据不出本地、模型聚合 |
| 联邦平均/联邦优化 | 算法 | 见本文 | 通信轮次、收敛性 |
| 差分隐私/安全聚合 | 隐私机制 | 隐私保护节 | 隐私保证 |
| 通信效率 | 约束 | §基本概念 | 压缩/稀疏/本地步数 |

#### 概念关系 / Concept Relations

| 源概念 | 目标概念 | 关系类型 | 说明 |
|--------|----------|----------|------|
| 联邦学习理论 | 09-01-17 神经网络 | depends_on | 本地模型 |
| 联邦学习理论 | 09-03-03 分布式算法 | depends_on | 聚合与通信 |
| 联邦学习理论 | 04-通信复杂度 | depends_on | 通信轮次 |
| 联邦学习理论 | 09-01-21 元学习 | 扩展 | 联邦元学习 |
...
联邦平均收敛性见联邦平均算法与联邦优化；隐私保证（差分隐私）见隐私保护；与 09-03-03 消息复杂度衔接。
...
#### 多维矩阵：联邦算法与隐私 / Multi-Dimensional Comparison

| 方法 | 通信轮次 | 收敛性 | 隐私保证 |
|------|----------|--------|----------|
| 联邦平均 | 每轮聚合 | 依凸性/非凸 | 无 |
| +差分隐私 | 同上 | 噪声影响 | $(\varepsilon,\delta)$-DP |
| +安全聚合 | 同上 | 同上 | 安全多方 |
| 压缩/稀疏 | 减少 | 依方法 | 依机制 |

#### 决策树：联邦学习选型 / Decision Tree
...
flowchart TD
  Need([需求])
  Need --> CrossDevice[跨设备]
  Need --> CrossOrg[跨机构]
  Need --> Privacy[隐私敏感]
  CrossDevice --> FedAvg[联邦平均]
  CrossOrg --> FedAvg
  Privacy --> DP[+差分隐私/安全聚合]
```
...
testFederatedLearningAlgorithms = do
    putStrLn "Testing Federated Learning Algorithms\cdots"
...
**研究内容**:
2024年联邦学习在医疗应用取得重要进展。FeTS(Federated Tumor Segmentation)项目建立了大规模多机构脑肿瘤分割联邦学习基准，涉及全球23个机构的数据。该工作解决了医学影像分析中的数据孤岛问题，同时保护患者隐私。

**关键论文**:

- [Pati et al. 2024]: "The Federated Tumor Segmentation (FeTS) Challenge 2024". *Nature Machine Intelligence*.
- [Dayan et al. 2024]: "Federated Learning for Healthcare: Multi-Institutional Collaborations without Sharing Patient Data". *Scientific Reports*.

**对项目的影响**:
展示联邦学习算法在隐私敏感领域的实际应用，提供大规模联邦学习的最佳实践。

### 8.2 联邦学习隐私攻击与防御

**研究内容**:
2024年联邦学习的隐私攻击与防御理论研究取得进展。成员推断攻击和属性推断攻击的新方法被提出，同时差分隐私和安全聚合技术的结合进一步增强了隐私保护。

**关键论文**:

- [Nasr et al. 2024]: "Adversarial Privacy Auditing of Federated Learning". *IEEE S&P 2024*.
- [Cheu et al. 2024]: "Federated Learning with Differential Privacy: Algorithmic Guarantees and Attacks". *CCS 2024*.

**对项目的影响**:
深化对联邦学习隐私风险的理论理解，为设计更安全的联邦学习算法提供指导。
