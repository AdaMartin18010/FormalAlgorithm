...
5. **Hard, A., Rao, K., Mathews, R., Ramaswamy, S., Beaufays, F., Augenstein, S., Eichner, H., Kiddon, C., & Ramage, D.** (2018). "Federated learning for mobile keyboard prediction". *arXiv preprint arXiv:1811.03604*.
