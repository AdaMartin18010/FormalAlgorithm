...
- [X. 实际应用案例 / Practical Applications](#x-实际应用案例--practical-applications)
  - [X.1 LCS（最长公共子序列）应用案例](#x1-lcs最长公共子序列应用案例)
  - [X.2 背包问题应用案例](#x2-背包问题应用案例)
  - [X.3 编辑距离应用案例](#x3-编辑距离应用案例)
...
> 💻 **代码示例引用**：动态规划（包括0/1背包问题）的完整实现可参见 [`docs/示例库/01-标准示例集.md`](../../示例库/01-标准示例集.md) 及 [`examples/`](../../../examples/) 目录。
...
- 理解[derive(Debug)]的核心概念
- 掌握[derive(Debug)]的形式化表示
