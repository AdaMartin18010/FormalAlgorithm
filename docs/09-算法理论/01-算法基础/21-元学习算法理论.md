---
title: 9.1.21 元学习算法理论 / Meta-Learning Algorithm Theory
version: 1.0
status: maintained
...
## 9.1.21 元学习算法理论 / Meta-Learning Algorithm Theory

### 摘要 / Executive Summary

- 统一元学习算法的形式化定义、MAML、Few-shot学习与元学习设计技术。
- 建立元学习算法在机器学习中的核心地位。

### 关键术语与符号 / Glossary

- 元学习算法、MAML、Few-shot学习、学习如何学习、元优化、快速适应。
- 术语对齐与引用规范：`docs/术语与符号总表.md`，`01-基础理论/00-撰写规范与引用指南.md`

### 术语与符号规范 / Terminology & Notation

- 元学习算法（Meta-Learning Algorithm）：学习如何学习的算法。
- MAML（Model-Agnostic Meta-Learning）：模型无关的元学习算法。
- Few-shot学习（Few-shot Learning）：从少量样本中学习的任务。
- 学习如何学习（Learning to Learn）：元学习的核心思想。
- 记号约定：`θ` 表示元参数，`φ` 表示任务参数，`L` 表示损失函数。
...
元学习可与 **Stanford CS 330**、**CMU 10-403** 及 Meta-Learning 专题对标。课程与模块映射见 [国际课程对标表](../../国际课程对标表.md)。
...
- [9.1.21 元学习算法理论 / Meta-Learning Algorithm Theory](#9121-元学习算法理论--meta-learning-algorithm-theory)
...
- [基本概念 (Basic Concepts)](#基本概念-basic-concepts)
  ...
  - [内容补充与思维表征 / Content Supplement and Thinking Representation](#内容补充与思维表征--content-supplement-and-thinking-representation)
    ...
    - [多维矩阵：元学习方法对比 / Multi-Dimensional Comparison](#多维矩阵元学习方法对比--multi-dimensional-comparison)
    - [决策树：元学习方法选型 / Decision Tree](#决策树元学习方法选型--decision-tree)
...
元学习“学习如何学习”，在任务分布上优化内循环（任务内）与外循环（跨任务）以支持少样本与快速适应。MAML、原型网络、关系网络等与 09-01-17 神经网络、09-01-20 联邦学习衔接。

#### 概念属性表 / Concept Attribute Table

| 属性名 | 类型/范围 | 含义 | 备注 |
|--------|-----------|------|------|
| 元学习 | 学习范式 | §基本概念 | 内循环/外循环 |
| 任务分布/少样本/迁移 | 设定 | §基本概念 | way-shot、快速适应 |
| MAML/原型/关系网络 | 方法 | 见本文 | 适用任务与设定 |

#### 概念关系 / Concept Relations

| 源概念 | 目标概念 | 关系类型 | 说明 |
|--------|----------|----------|------|
| 元学习理论 | 09-01-17 神经网络 | depends_on | 基模型与优化 |
| 元学习理论 | 09-01-01 算法设计 | depends_on | 内外循环设计 |
| 元学习理论 | 09-01-20 联邦 | 扩展 | 联邦元学习 |
| 元学习理论 | 09-01-19 图神经网络 | 扩展 | 图上的元学习 |
...
MAML 一阶/二阶近似与收敛见模型无关元学习；原型网络与度量学习见原型网络；与 09-01-17 泛化衔接。
...
#### 多维矩阵：元学习方法对比 / Multi-Dimensional Comparison

| 方法 | 内循环/外循环 | 适用任务 | 少样本设定 |
|------|----------------|----------|------------|
| MAML | 梯度更新/元梯度 | 分类/回归 | way-shot |
| 原型网络 | 原型计算/度量 | 分类 | way-shot |
| 关系网络 | 关系模块/度量 | 分类/回归 | way-shot |

#### 决策树：元学习方法选型 / Decision Tree
...
testMetaLearningAlgorithms = do
    putStrLn "Testing Meta-Learning Algorithms\cdots"
