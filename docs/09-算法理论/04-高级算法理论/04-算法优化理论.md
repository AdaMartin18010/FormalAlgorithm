...
3. **Hennessy, J. L., & Patterson, D. A.** (2011). *Computer Architecture: A Quantitative Approach* (5th ed.). Elsevier.
4. **Muchnick, S. S.** (1997). *Advanced Compiler Design and Implementation*. Morgan Kaufmann.
5. **Patterson, D. A., & Hennessy, J. L.** (2013). *Computer Organization and Design: The Hardware/Software Interface* (5th ed.). Newnes.
