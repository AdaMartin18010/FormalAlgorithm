# 13-算法合成理论 / Algorithm Synthesis Theory
...
- [13-算法合成理论 / Algorithm Synthesis Theory](#13-算法合成理论--algorithm-synthesis-theory)
  ...
  - [8. 参考文献 / References](#8-参考文献--references)
    - [8.1 经典论文 / Classic Papers](#81-经典论文--classic-papers)
    - [8.2 现代发展 / Modern Developments](#82-现代发展--modern-developments)
    - [8.3 实践应用 / Practical Applications](#83-实践应用--practical-applications)
...
### 8.1 经典论文 / Classic Papers

1. **Alur, R., et al. (2013). Syntax-Guided Synthesis. IEEE.**
   - 语法引导合成的开创性工作 / Groundbreaking work on syntax-guided synthesis
   - 形式化规约语言 / Formal specification languages
   - 合成算法框架 / Synthesis algorithm framework

2. **Solar-Lezama, A. (2008). Program Synthesis by Sketching. UC Berkeley.**
   - 程序草图的合成方法 / Sketch-based program synthesis
   - 约束求解技术 / Constraint solving techniques
   - 程序合成工具 / Program synthesis tools

### 8.2 现代发展 / Modern Developments

1. **Gulwani, S., et al. (2017). Program Synthesis. Foundations and Trends in Programming Languages.**
   - 程序合成的综合概述 / Comprehensive overview of program synthesis
   - 最新技术进展 / Latest technical advances
   - 应用领域分析 / Application domain analysis

2. **Jha, S., & Seshia, S. A. (2017). A Theory of Formal Synthesis via Inductive Learning. ACM TOPLAS.**
   - 基于归纳学习的合成理论 / Synthesis theory based on inductive learning
   - 机器学习在合成中的应用 / Application of machine learning in synthesis
   - 形式化验证方法 / Formal verification methods

### 8.3 实践应用 / Practical Applications

1. **Udupa, A., et al. (2013). TRANSIT: Specifying Protocols with Conic Automata. PLDI.**
   - 协议规约的自动合成 / Automatic synthesis of protocol specifications
   - 并发系统验证 / Concurrent system verification
   - 实际应用案例 / Practical application cases

2. **Kneuss, E., et al. (2015). Synthesis Modulo Recursive Functions. PLDI.**
   - 递归函数的合成 / Synthesis of recursive functions
   - 函数式编程应用 / Functional programming applications
