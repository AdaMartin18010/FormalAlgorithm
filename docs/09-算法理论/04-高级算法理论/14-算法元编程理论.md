...
- [基本概念 / Basic Concepts](#基本概念--basic-concepts)
  ...
  - [内容补充与思维表征 / Content Supplement and Thinking Representation](#内容补充与思维表征--content-supplement-and-thinking-representation)
    ...
    - [决策树：元编程选型 / Decision Tree](#决策树元编程选型--decision-tree-1)
...
- [10. 参考文献 / References](#10-参考文献--references)
  ...
  - [10.2 顶级期刊论文 / Top Journal Papers](#102-顶级期刊论文--top-journal-papers)
    - [算法元编程理论顶级期刊 / Top Journals in Algorithm Metaprogramming Theory](#算法元编程理论顶级期刊--top-journals-in-algorithm-metaprogramming-theory-1)
- [参考文献](#参考文献-1)
- [知识导航](#知识导航-1)
- [学习目标](#学习目标-1)
...
title: 9.4.18 算法元编程理论 / Algorithm Metaprogramming Theory
version: 1.0
status: maintained
