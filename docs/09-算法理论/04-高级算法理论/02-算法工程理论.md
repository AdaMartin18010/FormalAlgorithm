...
flowchart TD
  Need([需求：图算法/ML等])
  Need --> Stage[生命周期阶段与工具 §9]
  Stage --> Impl[实现/测试/优化/部署]
```
...
- 理解.github/workflows/algorithm-engineering.yml的核心概念
- 掌握.github/workflows/algorithm-engineering.yml的形式化表示
