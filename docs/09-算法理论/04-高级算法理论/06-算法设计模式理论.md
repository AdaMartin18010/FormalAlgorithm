---
title: 9.4.6 算法设计模式理论 / Algorithm Design Pattern Theory
version: 1.0
status: maintained
...
graph LR
  Def[设计模式定义 §2]
  Class[模式分类 §2.2]
  Classic[经典模式 分治/DP/贪心 §3]
  Type[创建型/结构型/行为型 §4-§6]
  Def --> Class
  Class --> Classic
  Classic --> Type
```
