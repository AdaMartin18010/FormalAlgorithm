# 高阶逻辑理论 / Higher-Order Logic Theory

## 目录

- [高阶逻辑理论 / Higher-Order Logic Theory](#高阶逻辑理论--higher-order-logic-theory)
  - [目录](#目录)
...
3. Henkin, L. (1950). Completeness in the theory of types. Journal of Symbolic Logic.
4. Gallier, J. H. (1986). Logic for computer science: Foundations of automatic theorem proving. Harper & Row.
5. Fitting, M. (1996). First-order logic and automated theorem proving. Springer.
