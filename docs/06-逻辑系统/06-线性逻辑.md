...
## 6.6 线性逻辑 / Linear Logic

### 摘要 / Executive Summary

- 统一线性逻辑的形式化定义、序贯演算与语义理论。
- 建立资源敏感逻辑的完整理论框架。

### 关键术语与符号 / Glossary

- 线性逻辑、资源敏感性、序贯演算、相位语义、Curry-Howard-Girard对应。
- 术语对齐与引用规范：`docs/术语与符号总表.md`，`01-基础理论/00-撰写规范与引用指南.md`

### 术语与符号规范 / Terminology & Notation

- 线性逻辑（Linear Logic）：资源敏感的逻辑系统，每个资源只能使用一次。
- 线性蕴含（Linear Implication）：`⊸` 表示线性蕴含。
- 张量积（Tensor Product）：`⊗` 表示不可交换的合取。
- 记号约定：`⊸` 表示线性蕴含，`⊗` 表示张量积，`&` 表示加法合取。
...
- [6.6 线性逻辑 / Linear Logic](#66-线性逻辑--linear-logic)
...
- [基本概念 / Basic Concepts](#基本概念--basic-concepts)
  - [线性逻辑的动机 / Motivation for Linear Logic](#线性逻辑的动机--motivation-for-linear-logic)
  - [线性逻辑与其他逻辑的关系 / Relationship with Other Logics](#线性逻辑与其他逻辑的关系--relationship-with-other-logics)
- [语法 / Syntax](#语法--syntax)
  - [基本连接词 / Basic Connectives](#基本连接词--basic-connectives)
  - [连接词的直觉解释 / Intuitive Interpretation of Connectives](#连接词的直觉解释--intuitive-interpretation-of-connectives)
- [序贯演算 / Sequent Calculus](#序贯演算--sequent-calculus)
  - [线性逻辑序贯演算系统 / Linear Logic Sequent Calculus System](#线性逻辑序贯演算系统--linear-logic-sequent-calculus-system)
- [语义 / Semantics](#语义--semantics)
  - [相位语义 / Phase Semantics](#相位语义--phase-semantics)
  - [游戏语义 / Game Semantics](#游戏语义--game-semantics)
- [计算解释 / Computational Interpretation](#计算解释--computational-interpretation)
  - [Curry-Howard-Girard对应 / Curry-Howard-Girard Correspondence](#curry-howard-girard对应--curry-howard-girard-correspondence)
- [应用领域 / Application Areas](#应用领域--application-areas)
  - [并发计算 / Concurrent Computation](#并发计算--concurrent-computation)
...
- [参考文献 / References](#参考文献--references)
  ...
  - [应用研究 / Application Research](#应用研究--application-research)
...
1. [Girard1987] Girard, J.-Y. (1987). "Linear Logic". *Theoretical Computer Science*, 50(1): 1-102. DOI: 10.1016/0304-3975(87)90045-4
   - **Girard线性逻辑的开创性论文**，资源敏感逻辑的奠基之作。本文档的全部内容基于此论文。
...
1. **Wikipedia - Linear Logic**: <https://en.wikipedia.org/wiki/Linear_logic>
   - 线性逻辑的Wikipedia条目，包含Girard的线性逻辑系统和资源敏感逻辑（截至2025年1月11日）。

2. **Wikipedia - Resource-Sensitive Logic**: <https://en.wikipedia.org/wiki/Resource_sensitive_logic>
   - 资源敏感逻辑的Wikipedia条目，介绍线性逻辑的资源管理特性（截至2025年1月11日）。
