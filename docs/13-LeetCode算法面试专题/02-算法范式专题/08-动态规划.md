...
- [3. 经典题目详解 / Classic Problem Analysis](#3-经典题目详解--classic-problem-analysis)
  ...
  - [3.3 LeetCode 300 — Longest Increasing Subsequence](#33-leetcode-300--longest-increasing-subsequence)
    - [形式化规约 / Formal Specification](#形式化规约--formal-specification-2)
    - [核心思路 / Core Idea](#核心思路--core-idea-2)
    - [最优子结构引理 / Optimal Substructure Lemma](#最优子结构引理--optimal-substructure-lemma-2)
    - [二分优化正确性 / Binary Optimization Correctness](#二分优化正确性--binary-optimization-correctness)
    - [代码实现 / Code Implementations](#代码实现--code-implementations-2)
    - [复杂度分析 / Complexity Analysis](#复杂度分析--complexity-analysis-2)
  - [3.4 LeetCode 72 — Edit Distance](#34-leetcode-72--edit-distance)
    - [形式化规约 / Formal Specification（Levenshtein 距离）](#形式化规约--formal-specificationlevenshtein-距离)
    - [核心思路 / Core Idea](#核心思路--core-idea-3)
    - [最优子结构引理 / Optimal Substructure Lemma](#最优子结构引理--optimal-substructure-lemma-3)
  ...
  - [3.5 LeetCode 416 — Partition Equal Subset Sum](#35-leetcode-416--partition-equal-subset-sum)
    - [形式化规约 / Formal Specification（0/1 背包判定）](#形式化规约--formal-specification01-背包判定)
    - [核心思路 / Core Idea](#核心思路--core-idea-4)
    - [最优子结构引理 / Optimal Substructure Lemma](#最优子结构引理--optimal-substructure-lemma-4)
    - [代码实现 / Code Implementations](#代码实现--code-implementations-4)
    - [复杂度分析 / Complexity Analysis](#复杂度分析--complexity-analysis-4)
    - [正确性证明 / Correctness Proof](#正确性证明--correctness-proof-3)
  - [3.6 LeetCode 312 — Burst Balloons](#36-leetcode-312--burst-balloons)
    - [形式化规约 / Formal Specification](#形式化规约--formal-specification-3)
    - [核心思路 / Core Idea](#核心思路--core-idea-5)
    - [最优子结构引理 / Optimal Substructure Lemma](#最优子结构引理--optimal-substructure-lemma-5)
    - [代码实现 / Code Implementations](#代码实现--code-implementations-5)
    - [复杂度分析 / Complexity Analysis](#复杂度分析--complexity-analysis-5)
    - [正确性证明 / Correctness Proof](#正确性证明--correctness-proof-4)
- [4. 复杂度分析体系 / Complexity Analysis](#4-复杂度分析体系--complexity-analysis)
  - [4.1 时间复杂度通用公式](#41-时间复杂度通用公式)
  - [4.2 六道经典题复杂度汇总](#42-六道经典题复杂度汇总)
  - [4.3 空间优化：滚动数组条件](#43-空间优化滚动数组条件)
- [5. 正确性证明框架 / Correctness Proof Framework](#5-正确性证明框架--correctness-proof-framework)
  - [5.1 引理：最优子结构](#51-引理最优子结构)
  - [5.2 定理：DP 正确性](#52-定理dp-正确性)
  - [5.3 Mermaid 证明树](#53-mermaid-证明树)
- [6. 思维表征 / Thinking Representations](#6-思维表征--thinking-representations)
  - [6.1 概念依赖图](#61-概念依赖图)
  - [6.2 决策树：最优化问题范式选择](#62-决策树最优化问题范式选择)
  - [6.3 多维矩阵：六道经典题对比](#63-多维矩阵六道经典题对比)
  - [6.4 思维导图：DP 四大分支](#64-思维导图dp-四大分支)
  - [6.5 证明决策树：从定义到定理的推理链](#65-证明决策树从定义到定理的推理链)
- [7. 常见错误与反模式 / Common Mistakes and Anti-Patterns](#7-常见错误与反模式--common-mistakes-and-anti-patterns)
  - [7.1 状态设计维度不足/过多](#71-状态设计维度不足过多)
  - [7.2 遍历顺序错误（0/1 背包 vs 完全背包）](#72-遍历顺序错误01-背包-vs-完全背包)
  - [7.3 空间优化时覆盖未使用状态](#73-空间优化时覆盖未使用状态)
  - [7.4 树形 DP 中"换根"技巧的形式化描述](#74-树形-dp-中换根技巧的形式化描述)
- [8. 自测问题 / Self-Assessment Questions](#8-自测问题--self-assessment-questions)
  - [问题 1：最长简单路径为什么不能用 DP？](#问题-1最长简单路径为什么不能用-dp)
  - [问题 2：0/1 背包与完全背包的遍历顺序差异？](#问题-201-背包与完全背包的遍历顺序差异)
  - [问题 3：树形 DP 换根技巧的形式化？](#问题-3树形-dp-换根技巧的形式化)
  - [问题 4：状态压缩 DP 的适用条件？](#问题-4状态压缩-dp-的适用条件)
  - [问题 5：如何判断一个问题该用 DP 还是贪心？](#问题-5如何判断一个问题该用-dp-还是贪心)
  - [问题 6：LC 300 LIS 二分优化中，$tails$ 数组为什么保持递增？](#问题-6lc-300-lis-二分优化中tails-数组为什么保持递增)
  - [问题 7：编辑距离的替换操作为什么代价是 1 而不是 2？](#问题-7编辑距离的替换操作为什么代价是-1-而不是-2)
  - [问题 8：区间 DP 为什么按长度递增填表？](#问题-8区间-dp-为什么按长度递增填表)
...
- `01-算法基础/02-递归与分治.md` — 递归与分治策略的基本框架
- `01-算法基础/03-贪心算法.md` — 贪心选择性质与 DP 的对比
...
- 01-算法基础/02-递归与分治.md — 递归与分治框架

**同层专题**:

- [05-二分查找.md](./05-二分查找.md) — LIS 的二分优化应用
- [06-双指针.md](./02-双指针.md) — 双指针与 DP 的联合应用

**下游应用**:

- [../01-数据结构专题/05-二叉树与BST.md](../01-数据结构专题/05-二叉树与BST.md) — 树形 DP
...
<!-- 自动添加的代码引用 -->
- [`lc0070_climbing_stairs.rs`](../../../examples/algorithms-rust/src/leetcode/lc0070_climbing_stairs.rs)

<!-- 自动添加的代码引用 -->
- [`lc0070_climbing_stairs.lean`](../../../examples/lean_proofs/FormalAlgorithm/leetcode/lc0070_climbing_stairs.lean)

<!-- 自动添加的代码引用 -->
- [`lc0072_edit_distance.lean`](../../../examples/lean_proofs/FormalAlgorithm/leetcode/lc0072_edit_distance.lean)

<!-- 自动添加的代码引用 -->
- [`lc0198_house_robber.lean`](../../../examples/lean_proofs/FormalAlgorithm/leetcode/lc0198_house_robber.lean)

<!-- 自动补充的代码引用 -->
- [`lc0322_coin_change.py`](../../../examples/algorithms-python/src/leetcode/lc0322_coin_change.py)
