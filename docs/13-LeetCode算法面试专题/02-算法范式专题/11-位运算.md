...
- [`01-基础理论/01-数学基础/02-离散数学.md`](../../01-基础理论/01-数学基础/02-离散数学.md) — 布尔代数、群论基础
- [`01-基础理论/01-数学基础/03-数论.md`](../../01-基础理论/01-数学基础/03-数论.md) — 整数的二进制表示与模运算
- [`05-类型理论/01-类型系统基础.md`](../../05-类型理论/01-类型系统基础.md) — 整数类型的位宽与溢出行为
...
- [离散数学](../../01-基础理论/01-数学基础/02-离散数学.md) — 布尔代数、群论基础
- [数论](../../01-基础理论/01-数学基础/03-数论.md) — 整数的二进制表示
- [整数类型](../../05-类型理论/01-类型系统基础.md) — 位宽、补码、溢出

**后续拓展 / Extensions**:

- [状态压缩 DP](../04-高级算法专题/03-状态压缩DP.md) — 位掩码在动态规划中的高级应用
- [布隆过滤器](../../03-数据结构/05-集合/02-布隆过滤器.md) — 位运算在概率数据结构中的应用
