...
- 对应 Gentzen (1935) 原始论文 [Gentzen1935]
- 对齐 van Dalen《Logic and Structure》§1.5 [VanDalen2013]
- 对齐 MIT 6.042J / Stanford CS103 课程内容 [MIT6042J]
...
- 对齐 Hilbert & Ackermann《Principles of Mathematical Logic》 [HilbertAckermann1950]
- 对应 Mendelson《Introduction to Mathematical Logic》§1.4 [Mendelson2015]
...
1. [Gentzen1935] Gentzen, G. (1935). "Investigations into Logical Deduction". *Mathematische Zeitschrift*, 39(1), 176-210. DOI: 10.1007/BF01201353.
   - 自然演绎与序列演算的奠基论文。本文档§1.2的参考来源。

2. [VanDalen2013] van Dalen, D. (2013). *Logic and Structure* (5th Edition). Springer. ISBN: 978-1447145578.
   - 逻辑学标准教材，涵盖自然演绎与直觉主义逻辑。本文档§1.2的参考来源。

3. [HilbertAckermann1950] Hilbert, D., & Ackermann, W. (1950). *Principles of Mathematical Logic*. Chelsea. ISBN: 978-0828401395.
   - Hilbert 系统的经典教材。本文档§1.3的参考来源。

4. [Mendelson2015] Mendelson, E. (2015). *Introduction to Mathematical Logic* (6th Edition). CRC Press. ISBN: 978-1482237726.
   - 数理逻辑标准教材。本文档§1.3的参考来源。

5. [Troelstra2000] Troelstra, A. S., & Schwichtenberg, H. (2000). *Basic Proof Theory* (2nd Edition). Cambridge University Press. ISBN: 978-0521779111.
   - 证明论标准教材，涵盖自然演绎、序列演算与切割消除。本文档整体框架的参考来源。

**课程资料 / Course Materials**:

1. [MIT6042J] Meyer, A. R. (2010). *Mathematics for Computer Science* (MIT 6.042J). MIT OpenCourseWare. URL: <https://ocw.mit.edu/courses/6-042j-mathematics-for-computer-science-fall-2010/>
   - MIT 经典离散数学课程，涵盖命题逻辑与证明技术。本文档习题设计参考此课程。
