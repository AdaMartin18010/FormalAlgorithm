...
**定义 4.1.1** (结构归纳法 / Structural Induction) [Burstall1969][Aczel1977]
...
**定义 5.1.1** (良基关系 / Well-Founded Relation) [Enderton1977][Halmos1960]
...
1. [Enderton1977] Enderton, H. B. (1977). *Elements of Set Theory*. Academic Press. ISBN: 978-0122384407.
   - 集合论教材，包含良基归纳法的完整理论。本文档§5的良基关系定义参考此书。

2. [Halmos1960] Halmos, P. R. (1960). *Naive Set Theory*. Van Nostrand.
   - 朴素集合论的经典教材，介绍归纳法的基础。

3. [Rosen2018] Rosen, K. H. (2018). *Discrete Mathematics and Its Applications* (8th Edition). McGraw-Hill. ISBN: 978-1259676512.
   - 离散数学教材，系统介绍数学归纳法和强归纳法。本文档§2-§3的内容参考此书。

4. [GrahamKnuthPatashnik1994] Graham, R. L., Knuth, D. E., & Patashnik, O. (1994). *Concrete Mathematics* (2nd Edition). Addison-Wesley. ISBN: 978-0201558029.
   - 具体数学，包含大量归纳法应用示例。本文档§2的求和公式证明参考此书。
