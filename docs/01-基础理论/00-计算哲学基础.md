...
- [计算哲学基础 / Philosophy of Computation Foundation](#计算哲学基础--philosophy-of-computation-foundation)
  ...
  - [8. 参考文献 / References](#8-参考文献--references)
    ...
    - [计算理论文献 / Computational Theory Literature](#计算理论文献--computational-theory-literature)
    - [认知科学文献 / Cognitive Science Literature](#认知科学文献--cognitive-science-literature)
    - [伦理学文献 / Ethics Literature](#伦理学文献--ethics-literature)
    - [形而上学文献 / Metaphysics Literature](#形而上学文献--metaphysics-literature)
...
### 认知科学文献 / Cognitive Science Literature
...
3. Pylyshyn, Z. W. (1984). Computation and cognition: Toward a foundation for cognitive science

### 伦理学文献 / Ethics Literature

1. Floridi, L. (2013). The ethics of information
2. Mittelstadt, B. D., et al. (2016). The ethics of algorithms: Mapping the debate
3. Barocas, S., & Selbst, A. D. (2016). Big data's disparate impact

### 形而上学文献 / Metaphysics Literature

1. Wheeler, J. A. (1990). Information, physics, quantum: The search for links
2. Lloyd, S. (2006). Programming the universe: A quantum computer scientist takes on the cosmos
3. Deutsch, D. (1997). The fabric of reality: The science of parallel universes and its implications

### 在线资源 / Online Resources

1. Stanford Encyclopedia of Philosophy: Philosophy of Computer Science
2. Internet Encyclopedia of Philosophy: Computational Theory of Mind
3. SEP: Church-Turing Thesis
4. SEP: Computational Complexity Theory

### 国际标准 / International Standards

1. IEEE Computer Society: Software Engineering Standards
2. ACM: Computing Curricula
3. ISO/IEC: Information Technology Standards
4. W3C: Web Standards
