...
本模块为随机算法、学习理论与复杂度分析提供概率与统计基础。若需**面向机器学习与数据科学**的系统化概率/统计与优化导读，可参考：

- **MML book**（*Mathematics for Machine Learning*）：概率章节覆盖贝叶斯推断、高斯分布、指数族。
- **Coursera Mathematics for ML and Data Science**、**CMU 10-606 Math for ML**：统计推断、学习理论、PAC 界等。
- **CS2023 数学要求**：本科课程指南增强数学与统计，与 01-02、本模块及 [AI与算法数学参考](../AI与算法数学参考.md) 对齐。
- **贝叶斯推断、统计推断与学习理论**：与 [09-01-11 随机算法理论](../09-算法理论/01-算法基础/11-随机算法理论.md)、[09-01-12 近似算法理论](../09-算法理论/01-算法基础/12-近似算法理论.md) 及 10-高级主题 中 ML 文档衔接，如 [10-05 量子机器学习理论](../10-高级主题/05-量子机器学习.md)、[10-19 量子机器学习理论](../10-高级主题/19-量子机器学习理论.md)、[10-28 算法量子机器学习理论](../10-高级主题/28-算法量子机器学习理论.md) 等（数学前置与概率/统计要求见各文档）。

详见 [国际课程对标表](../国际课程对标表.md) 与 [AI与算法数学参考](../AI与算法数学参考.md)。
...
- [Implement a Bloom filter and analyze its false positive probability](#implement-a-bloom-filter-and-analyze-its-false-positive-probability)
- [知识导航](#知识导航)
- [学习目标](#学习目标)
...
**定义 1.1** 概率空间为三元组 $(\Omega, \mathcal{F}, \mathbb{P})$，其中样本空间 $\Omega$、事件域 $\mathcal{F}$ 与概率测度 $\mathbb{P}$ [Billingsley2012]。

A probability space is a triple $(\Omega, \mathcal{F}, \mathbb{P})$ with sample space $\Omega$, sigma-algebra $\mathcal{F}$, and probability measure $\mathbb{P}$ [Billingsley2012].
