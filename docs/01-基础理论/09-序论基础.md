...
- [*本文档提供了序论的基础理论及其在算法中的应用，包括偏序、全序、良序关系，以及它们在排序算法、优先队列、拓扑排序等算法中的具体应用。*](#本文档提供了序论的基础理论及其在算法中的应用包括偏序全序良序关系以及它们在排序算法优先队列拓扑排序等算法中的具体应用)
- [知识导航](#知识导航)
- [学习目标](#学习目标)
