---
title: 10.37 算法在边缘智能中的应用 / Algorithms in Edge Intelligence
version: 1.0
status: maintained
...
## 10.37 算法在边缘智能中的应用 / Algorithms in Edge Intelligence
...
- 边缘系统：`10-高级主题/30-边缘计算中的算法系统.md`，`10-高级主题/30-边缘计算中的算法系统.md`
...
算法在边缘智能中的应用将边缘智能定义与核心特征结合，涵盖边缘智能架构、模型压缩、联邦学习与边缘推理。与 10-30 边缘计算中的算法系统、10-27 联邦学习与隐私衔接；§基本概念、§边缘智能架构及后续各节形成完整表征。

#### 概念属性表 / Concept Attribute Table

| 属性名 | 类型/范围 | 含义 | 备注 |
|--------|-----------|------|------|
| 边缘智能定义、核心特征 | 基本概念 | §基本概念 | 与 10-30、10-27 对照 |
| 边缘智能架构、边缘智能算法(模型压缩/联邦学习/边缘推理)、边缘智能优化 | 架构/算法 | 延迟、隐私、带宽 | §各节 |
| 模型压缩/联邦学习/边缘推理 | 对比 | §各节 | 多维矩阵 |

#### 概念关系 / Concept Relations

| 源概念 | 目标概念 | 关系类型 | 说明 |
|--------|----------|----------|------|
| 算法在边缘智能中的应用 | 10-30、10-27 | depends_on | 边缘计算与联邦学习基础 |
| 算法在边缘智能中的应用 | 12 应用领域 | applies_to | 边缘智能实践 |
...
模型压缩正确性见 §边缘智能算法；联邦学习收敛性见 §边缘智能算法；与 10-30 论证衔接。
...
#### 多维矩阵：边缘智能技术对比 / Multi-Dimensional Comparison

| 概念/技术 | 延迟 | 隐私 | 带宽 | 备注 |
|-----------|------|------|------|------|
| 模型压缩/联邦学习/边缘推理 | §各节 | §各节 | §各节 | — |
...
flowchart TD
  Start([场景])
  Start --> Scene{场景?}
  Scene -->|低延迟/隐私/资源| Meth[模型压缩或联邦学习或边缘推理 §各节]
  Meth --> Impl[§实现示例]
```
...
flowchart TD
  Need([应用需求])
  Need --> App{需求类型?}
  App -->|视觉/语音/控制| Meth[边缘智能算法与优化 §实现示例]
  Meth --> Impl[§实现示例]
```
...
- `09-算法理论/01-算法基础/01-算法设计理论.md` - 算法设计理论（边缘智能算法设计范式）
- `09-算法理论/01-算法基础/22-算法六维分类框架.md` - 算法六维分类框架（并行/分布式特性维度）
- `04-算法复杂度/05-通信复杂度.md` - 通信复杂度（边缘计算的通信下界）
- `10-高级主题/30-边缘计算中的算法系统.md` - 边缘计算算法系统高级深化
- `view/算法全景梳理-2025-01-11.md` - 算法全景梳理（包含边缘智能算法概述）
- `view/VIEW内容总索引-2025-01-11.md` - VIEW文件夹完整索引

### 知识体系位置 / Knowledge System Position

本文档属于 **10-高级主题** 模块，是算法在边缘智能中的应用文档，为边缘智能系统的算法设计和优化提供理论基础和实践指导。

### VIEW文件夹相关文档 / VIEW Folder Related Documents

- `view/算法全景梳理-2025-01-11.md` §7 - 并行/分布式特性（边缘计算、分布式算法）
- `view/VIEW内容总索引-2025-01-11.md` - VIEW文件夹完整索引
