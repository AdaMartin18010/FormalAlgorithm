...
算法演化与遗传编程理论将演化算法与遗传编程结合，支持函数优化、符号回归与算法合成。与 09-04-21 算法演化理论、10-11/14 算法合成理论衔接；§基本概念、§遗传算法、§遗传编程、§多目标优化、§演化策略形成完整表征。

#### 概念属性表 / Concept Attribute Table

| 属性名 | 类型/范围 | 含义 | 备注 |
|--------|-----------|------|------|
| 演化算法 | 基本概念 | §基本概念 | 与 09-04-21、10-11 对照 |
| 遗传算法、遗传编程、多目标优化、演化策略 | 方法 | 表示形式、选择压力、适用问题 | §遗传算法、§遗传编程、§各节 |
| 遗传算法/遗传编程/演化策略 | 对比 | §各节 | 多维矩阵 |

#### 概念关系 / Concept Relations

| 源概念 | 目标概念 | 关系类型 | 说明 |
|--------|----------|----------|------|
| 算法演化与遗传编程理论 | 09-04-21、10-11/14 | depends_on | 演化与合成基础 |
| 算法演化与遗传编程理论 | 10-24 遗传编程 | applies_to | 应用实践 |
...
遗传算法收敛性见 §遗传算法；遗传编程正确性见 §遗传编程；与 09-04-21 论证衔接。
...
| 概念/方法 | 表示形式 | 选择压力 | 适用问题 | 备注 |
|-----------|----------|----------|----------|------|
| 遗传算法/遗传编程/演化策略 | §各节 | §各节 | §各节 | — |
...
flowchart TD
  Start([目标])
  Start --> Goal{目标?}
  Goal -->|函数优化/符号回归/算法合成| Meth[遗传算法或遗传编程或演化策略 §各节]
  Meth --> App[§应用案例]
```
...
flowchart TD
  Need([应用需求])
  Need --> App{需求类型?}
  App -->|优化目标/约束/表示需求| Meth[遗传算法或遗传编程或 CMA-ES §应用案例]
  Meth --> Impl[§应用案例]
```
