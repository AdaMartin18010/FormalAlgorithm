---
title: 10.13 量子计算复杂性理论 / Quantum Computational Complexity Theory
version: 1.0
status: maintained
...
## 10.13 量子计算复杂性理论 / Quantum Computational Complexity Theory

### 摘要 / Executive Summary

- 统一量子计算复杂性理论，研究量子计算的复杂度类、算法复杂度分析和下界理论。
- 建立量子计算复杂性理论在高级主题中的核心地位。

### 关键术语与符号 / Glossary

- 量子计算复杂性、量子复杂度类、BQP、QMA、量子算法复杂度、量子下界理论。
- 术语对齐与引用规范：`docs/术语与符号总表.md`，`01-基础理论/00-撰写规范与引用指南.md`

### 术语与符号规范 / Terminology & Notation

- 量子计算复杂性（Quantum Computational Complexity）：研究量子计算复杂度的理论。
- 量子复杂度类（Quantum Complexity Class）：量子计算中的复杂度类。
- BQP（Bounded-error Quantum Polynomial time）：有界错误量子多项式时间。
- QMA（Quantum Merlin-Arthur）：量子版本的MA类。
- 记号约定：`BQP` 表示有界错误量子多项式时间，`QMA` 表示量子MA类，`T` 表示时间，`S` 表示空间。

### 交叉引用导航 / Cross-References

- 量子计算复杂度理论：参见 `10-高级主题/08-量子计算复杂性理论.md`。
...
- [10.13 量子计算复杂性理论 / Quantum Computational Complexity Theory](#1013-量子计算复杂性理论--quantum-computational-complexity-theory)
...
- [基本概念 / Basic Concepts](#基本概念--basic-concepts)
  ...
  - [内容补充与思维表征 / Content Supplement and Thinking Representation](#内容补充与思维表征--content-supplement-and-thinking-representation)
    ...
    - [多维矩阵：量子复杂度类对比 / Multi-Dimensional Comparison](#多维矩阵量子复杂度类对比--multi-dimensional-comparison)
    - [决策树：问题类型到复杂度类选择 / Decision Tree](#决策树问题类型到复杂度类选择--decision-tree)
...
量子计算复杂性理论在量子图灵机/电路等模型下刻画时间与空间资源；BQP、QMA 等复杂度类与量子下界、查询复杂度构成理论栈。与 04-复杂度类、07-量子计算模型、10-08 量子计算复杂性理论衔接；§基本概念、§量子复杂度类、各节形成完整表征。

#### 概念属性表 / Concept Attribute Table

| 属性名 | 类型/范围 | 含义 | 备注 |
|--------|-----------|------|------|
| 量子复杂度 | 资源刻画 | 时间/空间 | §基本概念 |
| BQP/QMA/QCMA 等 | 复杂度类 | 量子图灵机/电路模型 | §量子复杂度类 |
| 量子算法复杂度分析 | 分析 | §各节 | 与 09-01-15 衔接 |
| 量子下界/查询复杂度 | 理论 | §各节 | 与 04-P/NP 对照 |

#### 概念关系 / Concept Relations

| 源概念 | 目标概念 | 关系类型 | 说明 |
|--------|----------|----------|------|
| 量子计算复杂性理论(10-13) | 04-算法复杂度、07-量子计算模型 | depends_on | 复杂度与模型基础 |
| 量子计算复杂性理论(10-13) | 10-08 量子计算复杂性理论 | depends_on | 理论衔接 |
| 量子计算复杂性理论(10-13) | 09-01-15 量子算法、04-P/NP | relates_to | 算法复杂度、复杂度层次 |
...
量子复杂度形式化见 §基本概念；BQP、QMA 定义与包含关系见 §量子复杂度类；下界与查询复杂度见 §各节；与 04、07 论证衔接。
...
#### 多维矩阵：量子复杂度类对比 / Multi-Dimensional Comparison

| 概念/类 | 时间/空间 | 与 P/NP 关系 | 备注 |
|---------|------------|--------------|------|
| BQP | 有界错误多项式时间 | P⊆BQP⊆PP | §量子复杂度类 |
| QMA | 量子证明 | NP⊆QMA | §量子复杂度类 |
| QCMA | 经典证明量子验证 | — | §量子复杂度类 |
| 与 04-复杂度类对照 | — | — | 多维矩阵对照 |

#### 决策树：问题类型到复杂度类选择 / Decision Tree

```mermaid
flowchart TD
  Start([问题类型])
  Start --> Type{类型?}
  Type -->|判定| BQP[BQP 等 §量子复杂度类]
  Type -->|优化| Class[对应复杂度类 §量子复杂度类]
  BQP --> Impl[本文 实现]
  Class --> Impl
```
...
flowchart TD
  Need([应用需求])
  Need --> App{需求类型?}
  App -->|量子算法复杂度分析| Anal[选模型与复杂度类 见本文]
  App -->|下界证明| Bound[选模型与复杂度类 见本文]
  Anal --> Impl[本文]
  Bound --> Impl
```
...
> 📚 **概念引用**：关于 **BQP类** 的完整定义，详见 [docs/知识图谱/concept_nodes.yaml](../知识图谱/concept_nodes.yaml) 中 bqp 的定义，或参见 [docs/04-算法复杂度/04-复杂度类.md](../04-算法复杂度/04-复杂度类.md)。
