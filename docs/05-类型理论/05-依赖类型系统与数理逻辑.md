...
3. [Lean4802024] The Lean Development Team. "Lean 4.8.0 Release Notes". June 5, 2024. https://github.com/leanprover/lean4/releases/tag/v4.8.0
   - 包含370+改进：Defeq和WHNF算法改进、终止性论证增强、函数归纳法支持、实例命名新算法、simp/omega增强等。
   - 本文档§5.8.3和§5.6.6基于此发布。

4. [CoqSortPolymorphism2025] Poiret, J., Gilbert, G., Maillard, K., Pédrot, P.-M., Sozeau, M., Tabareau, N., & Tanter, É. "All Your Base Are Belong to Us: Sort Polymorphism for Proof Assistants". *Proceedings of the ACM on Programming Languages (POPL'25)*, January 2025. DOI: 10.1145/3704912.
   - 开发了排序多态性及其元理论，在Coq中实现，支持跨排序的定义复用，为多排序类型理论提供基础设施。
   - 本文档§5.8.4基于此工作。

5. [UnfoldingControl2024] Gratzer, D., Sterling, J., Angiuli, C., Coquand, T., & Birkedal, L. "Controlling Unfolding in Type Theory". *Mathematical Structures in Computer Science*, 2025. DOI: 10.1017/S0960129525100327. (预印本arXiv:2210.05420, 2022)
   - 提出了基于扩展类型的定义展开控制理论，定义默认为不透明但支持选择性局部展开，在cooltt和Agda中实现。
   - 本文档§5.8.5基于此工作。

**教材与教程 / Textbooks and Tutorials:**

6. [Angiuli2025] Angiuli, C., & Gratzer, D. *Principles of Dependent Type Theory*. Cambridge University Press, 2025 (forthcoming). 草案：https://www.danielgratzer.com/papers/type-theory-book.pdf
   - 依赖类型理论的综合教材，涵盖外延和内涵类型论、模态类型论、同伦类型论、范畴论语义和证明助手实现技术。已被SPLV 2025等暑期学校采用。

7. [Escardo2025] Escardó, M. H. "Introduction to Homotopy Type Theory and Univalent Foundations (HoTT/UF) with Agda". Lecture Notes, November 2025. https://martinescardo.github.io/HoTT-UF-in-Agda-Lecture-Notes/
