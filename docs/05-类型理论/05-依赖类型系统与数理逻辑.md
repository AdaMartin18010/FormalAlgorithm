...
3. **Lean 4**:
   ...
   - 可运行示例: → [`examples/lean_proofs/dependent_types.lean`](../../examples/lean_proofs/dependent_types.lean) 与 [`examples/lean_proofs/hott_basics.lean`](../../examples/lean_proofs/hott_basics.lean)
