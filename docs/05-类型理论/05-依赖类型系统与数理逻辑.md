...
3. **Lean 4**:
   ...
   - 可运行示例: → [`examples/lean_proofs/FormalAlgorithm/dependent_types.lean`](../../examples/lean_proofs/FormalAlgorithm/dependent_types.lean) 与 [`examples/lean_proofs/FormalAlgorithm/hott_basics.lean`](../../examples/lean_proofs/FormalAlgorithm/hott_basics.lean)
...
- 理解05-依赖类型系统与数理逻辑的核心概念
- 掌握05-依赖类型系统与数理逻辑的形式化表示
