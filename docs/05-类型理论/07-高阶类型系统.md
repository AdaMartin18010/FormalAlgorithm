# 高阶类型系统 / Higher-Order Type System
...
6. [GirardLafontTaylor1989] Girard, J. Y., Lafont, Y., & Taylor, P. (1989). *Proofs and Types*. Cambridge University Press.
   - 证明论与类型论的经典教材。

**类型论与逻辑 / Type Theory and Logic**:

7. [Wadler2015] Wadler, P. (2015). "Propositions as Types". *Communications of the ACM*, 58(12): 75-84. DOI: 10.1145/2699407.
   - Wadler对Curry-Howard同构的现代综述，获ACM SIGPLAN奖。

8. [HoTTBook2013] Univalent Foundations Program. (2013). *Homotopy Type Theory: Univalent Foundations of Mathematics*. Institute for Advanced Study.
   - 同伦类型论的标准教材，高阶类型系统的现代发展。

**在线资源 / Online Resources**:

1. Haskell Wiki - Type Class: <https://wiki.haskell.org/Type_class>
   - 类型类的实用介绍。

2. nLab - Higher-Order Type Theory: <https://ncatlab.org/nlab/show/higher-order+type+theory>
   - 高阶类型论的范畴论视角。
