...
- [1. 中英术语对照表 (Chinese-English Terminology Reference)](#1-中英术语对照表-chinese-english-terminology-reference)
  ...
  - [目录 (Table of Contents)](#目录-table-of-contents)
    - [内容补充与思维表征 / Content Supplement and Thinking Representation（轻量）](#内容补充与思维表征--content-supplement-and-thinking-representation轻量)
      ...
      - [多维矩阵：各模块术语对比 / Multi-Dimensional Comparison](#多维矩阵各模块术语对比--multi-dimensional-comparison)
      - [决策树：模块到术语小节选择 / Decision Tree](#决策树模块到术语小节选择--decision-tree)
  ...
  - [新增术语对照（阶段5深化补充）](#新增术语对照阶段5深化补充)
    ...
    - [高阶算法 / Advanced Algorithms](#高阶算法--advanced-algorithms)
  - [参考文献](#参考文献)
  - [知识导航](#知识导航)
  - [学习目标](#学习目标)
...
中英术语对照表基于国际标准术语体系，与 01–12 各模块术语对齐，支撑 11-02 Wiki 国际概念对齐、11-03 多语言支持。§国际标准术语体系、§1.1–§1.10 形成完整表征。

#### 概念属性表 / Concept Attribute Table

| 属性名 | 类型/范围 | 含义 | 备注 |
|--------|-----------|------|------|
| 国际标准术语体系 | 基本概念 | §国际标准术语体系 | 与 11-02、11-03 对照 |
| 各节术语（基础理论/递归/…/算法理论） | 术语小节 | 中文/英文/定义/参考来源 | §1.1–§1.10 |
| 各模块术语 | 对比 | §1.1–§1.10 | 多维矩阵 |

#### 概念关系 / Concept Relations

| 源概念 | 目标概念 | 关系类型 | 说明 |
|--------|----------|----------|------|
| 中英术语对照表 | 01–12 各模块 | applies_to | 术语对齐 |
| 中英术语对照表 | 11-02、11-03 | relates_to | 国际化实践 |
...
术语与 ISO/IEEE/ACM 等标准对齐见 §国际标准术语体系；各模块术语一致性见 §1.1–§1.10。
...
#### 多维矩阵：各模块术语对比 / Multi-Dimensional Comparison

| 概念/模块 | 中文/英文 | 定义 | 参考来源 | 备注 |
|-----------|-----------|------|----------|------|
| 各模块术语 §1.1–§1.10 | §1.1–§1.10 | §1.1–§1.10 | §1.1–§1.10 | — |

#### 决策树：模块到术语小节选择 / Decision Tree

```mermaid
flowchart TD
  Start([模块])
  Start --> Mod{模块 01–12?}
  Mod --> Sect[对应术语小节 §1.1–§1.10]
  Sect --> Impl[§与项目结构主题的对齐]
```
...
flowchart TD
  Need([应用需求])
  Need --> App{撰写/翻译/对标?}
  App --> Meth[术语小节与项目结构对齐 §与项目结构主题的对齐]
  Meth --> Impl[§与项目结构主题的对齐]
```
...
- `view/算法全景梳理-2025-01-11.md` - 算法全景梳理（包含术语定义）
...
- `view/算法全景梳理-2025-01-11.md` §1 - 形式化定义（包含算法、信息、数据等术语定义）
- `view/VIEW内容总索引-2025-01-11.md` §6 - 标准对齐索引（Wikipedia概念对齐）
- `view/VIEW内容总索引-2025-01-11.md` - VIEW文件夹完整索引
...
> 本批次补充 HoTT、量子计算、机器学习、形式化验证与高阶算法领域术语共 37 个，每个术语标注中文、英文、缩写及项目内权威文档出处。

### 同伦类型论 / Homotopy Type Theory

| 中文 | 英文 | 缩写 | 定义出处 |
|---|---|---|---|
| 同伦类型论 | Homotopy Type Theory | HoTT | `docs/05-类型理论/03-同伦类型论-高级深化.md` |
| 单值公理 | Univalence Axiom | UA | `docs/05-类型理论/03-同伦类型论-高级深化.md` |
| 高阶归纳类型 | Higher Inductive Type | HIT | `docs/05-类型理论/03-同伦类型论-高级深化.md` |
| 纤维化 | Fibration | — | `docs/05-类型理论/03-同伦类型论-高级深化.md` |
| 泛等基础 | Univalent Foundations | UF | `docs/05-类型理论/03-同伦类型论-高级深化.md` |
| 路径类型 | Path Type | — | `docs/05-类型理论/03-同伦类型论-高级深化.md` |
| 立方类型论 | Cubical Type Theory | CTT | `docs/05-类型理论/03-同伦类型论-高级深化.md` |

### 量子计算 / Quantum Computing

| 中文 | 英文 | 缩写 | 定义出处 |
|---|---|---|---|
| 量子霸权 | Quantum Supremacy | — | `docs/07-计算模型/05-量子计算模型-高级深化.md` |
| 逻辑量子比特 | Logical Qubit | — | `docs/07-计算模型/05-量子计算模型-高级深化.md` |
| 量子纠错 | Quantum Error Correction | QEC | `docs/07-计算模型/05-量子计算模型-高级深化.md` |
| 拓扑量子计算 | Topological Quantum Computing | TQC | `docs/10-高级主题/08-量子计算复杂性理论.md` |
| 量子信道容量 | Quantum Channel Capacity | — | `docs/10-高级主题/04-量子信息论.md` |
| 量子查询复杂度 | Quantum Query Complexity | — | `docs/10-高级主题/08-量子计算复杂性理论.md` |
| 量子优势 | Quantum Advantage | — | `docs/07-计算模型/05-量子计算模型.md` |

### 机器学习 / Machine Learning

| 中文 | 英文 | 缩写 | 定义出处 |
|---|---|---|---|
| 大语言模型 | Large Language Model | LLM | `docs/09-算法理论/01-算法基础/26-机器学习算法基础.md` |
| Transformer | Transformer | — | `docs/09-算法理论/01-算法基础/26-机器学习算法基础.md` |
| 思维链 | Chain-of-Thought | CoT | `docs/09-算法理论/01-算法基础/26-机器学习算法基础.md` |
| 推测解码 | Speculative Decoding | — | `docs/09-算法理论/01-算法基础/26-机器学习算法基础.md` |
| 自监督学习 | Self-Supervised Learning | SSL | `docs/09-算法理论/01-算法基础/26-机器学习算法基础.md` |
| 联邦学习 | Federated Learning | FL | `docs/09-算法理论/01-算法基础/26-机器学习算法基础.md` |
| 注意力机制 | Attention Mechanism | — | `docs/09-算法理论/01-算法基础/26-机器学习算法基础.md` |

### 形式化验证 / Formal Verification

| 中文 | 英文 | 缩写 | 定义出处 |
|---|---|---|---|
| 自动形式化 | Autoformalization | — | `docs/10-高级主题/06-形式化验证的高级技术.md` |
| 定理证明器 | Theorem Prover | — | `docs/03-形式化证明/05-证明助手实践.md` |
| 交互式定理证明 | Interactive Theorem Proving | ITP | `docs/03-形式化证明/05-证明助手实践.md` |
| 模型检测 | Model Checking | — | `docs/08-实现示例/04-形式化验证.md` |
| 符号执行 | Symbolic Execution | — | `docs/10-高级主题/06-形式化验证的高级技术.md` |
| 霍尔逻辑 | Hoare Logic | — | `docs/09-算法理论/04-高级算法理论/19-算法形式化验证理论.md` |
| 程序验证 | Program Verification | — | `docs/08-实现示例/04-形式化验证.md` |
| 分离逻辑 | Separation Logic | — | `docs/10-高级主题/06-形式化验证的高级技术.md` |

### 高阶算法 / Advanced Algorithms

| 中文 | 英文 | 缩写 | 定义出处 |
|---|---|---|---|
| 二分图匹配 | Bipartite Matching | — | `docs/09-算法理论/01-算法基础/25-二分图匹配与稳定婚姻.md` |
| 在线算法 | Online Algorithm | — | `docs/09-算法理论/01-算法基础/13-在线算法理论.md` |
| 竞争比 | Competitive Ratio | — | `docs/09-算法理论/01-算法基础/13-在线算法理论.md` |
| 线性规划对偶性 | Linear Programming Duality | — | `docs/09-算法理论/04-高级算法理论/27-线性规划与对偶理论.md` |
| 稳定婚姻问题 | Stable Marriage Problem | SMP | `docs/09-算法理论/01-算法基础/25-二分图匹配与稳定婚姻.md` |
| 原始-对偶方法 | Primal-Dual Method | — | `docs/09-算法理论/04-高级算法理论/27-线性规划与对偶理论.md` |
| 近似比 | Approximation Ratio | — | `docs/09-算法理论/01-算法基础/12-近似算法理论.md` |
| 拟阵 | Matroid | — | `docs/09-算法理论/01-算法基础/07-贪心算法理论.md` |
...
- 理解1. 中英术语对照表 (Chinese-English Terminology Reference)的核心概念
- 掌握1. 中英术语对照表 (Chinese-English Terminology Reference)的形式化表示
